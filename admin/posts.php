                      ...
                      if(isset($_GET['source'])){       //kad switch dalykas veiktu, reikia daryti taip
                        ...
                        switch($source) {
                            ...
                            default:
                                ...
                                include "includes/view_all_posts.php";  //sita iterpiam cia tam, kad jeigu nieko negausim su 23 eilutej padaryta if busena $_GET['source], kad kazkas vistik butu visa laika
